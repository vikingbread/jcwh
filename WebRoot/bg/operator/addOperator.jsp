...
<html>
  ...
  <body>
  	<div id="container">
  	<h3>添加新操作员：</h3>
    <form action="OperatorAction!addOperator.action" method="post">
    	<table>
    		<tr>
    			<td class="label"><div>姓名:</div></td>
    			<td class="content"><div><input type="text"/ name="operator.name"></div></td>
    		</tr>
    		<tr>
    		...
    		<tr>
    			...
    			<td class="content"><div><input type="text" name="operator.phone" /></div></td>
    		</tr>
    		<tr>
    			<td class="label"><div>E-mail:</div></td>
    			<td class="content"><div><input type="text" name="operator.email" /></div></td>
    		</tr>
    		<tr>
    			<td class="label"><div>住址:</div></td>
    			<td class="content"><div><textarea name="operator.address"></textarea></div></td>
    		</tr>
    		<tr>
