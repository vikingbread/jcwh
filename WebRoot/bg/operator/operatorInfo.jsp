							...
							<td height="24" bgcolor="#353c44">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td>
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													...
													<td width="94%">
														<span class="STYLE1">操作员信息列表</span>
													</td>
												</tr>
											</table>
										</td>
										<td>
											<div align="right">
												<span class="STYLE1"> <a href="bg/operator/addOperator.jsp"
				...
				<c:otherwise>bgcolor="#f2f2f2"</c:otherwise></c:choose>>
								...
								<td height="20">
									<div align="center" class="STYLE21">
										<span><a href="OperatorAction!queryById.action?operator.id=${one.id}&forword=updatePage">修改</a>
										</span> |
										<span><a
											href="OperatorAction!deleteById.action?operator.id=${one.id }&page.pageNo=${page.pageNo}"
											onclick="return confirm('你正在执行的操作将使得本操作员不再可用,你确定要执行?')">删除</a>
										</span> |
										<span><a href="OperatorAction!queryById.action?operator.id=${one.id}&forword=detailPage">详细</a></span>
									</div>
								</td>
							</tr>
						</c:forEach>
									...
									<tr>
										<td width="49">
											<div align="center">
												<span class="STYLE22"><a
													href="OperatorAction!queryAll.action?page.pageNo=1" class="STYLE13">首页</a>
												</span>
											</div>
										</td>
										<c:if test="${page.pageNo!='1' }">
											<td width="49">
												<div align="center">
													<span class="STYLE22"><a
														href="OperatorAction!queryAll.action?page.pageNo=${page.pageNo-1}"
														class="STYLE13">上一页</a>
													</span>
												</div>
											</td>
										...
										<td width="49">
											<div align="center">
												<span class="STYLE22"><a
													href="OperatorAction!queryAll.action?page.pageNo=${page.allPage}"
													class="STYLE13">末页</a>
												</span>
											</div>
										</td>
